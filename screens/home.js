            ...
            Alert.alert(
                ...
                [
                    ...
                    },
                    {
                        text: 'Yes',
                        onPress: () => {
                            AsyncStorage.setItem('Master', JSON.stringify(appStore));
                        }
                    }
                ]
            )
        ...
        <ScrollView style={globalStyles.homeBG}>
            ...
            <View style={{flex:1, flexDirection: 'row', justifyContent: 'space-between'}}>
                ...
                <TouchableOpacity onPress ={clearAll}>
                    <Text style={{color: 'blue', borderRadius: 8, padding: 10, margin: 15, marginBottom: 5, marginLeft: 40, fontSize: 18}}>Clear All</Text>
                </TouchableOpacity>

                <TouchableOpacity onPress ={save}>
                    <Text style={{color: 'blue', borderRadius: 8, padding: 10, margin: 15, marginBottom: 5, marginRight: 40, fontSize: 18}}>Save</Text>
                </TouchableOpacity>
